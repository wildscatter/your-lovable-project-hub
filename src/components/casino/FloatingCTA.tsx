  ...
  return (
    <>
      <div className="fixed bottom-6 right-4 z-50 flex flex-col items-end gap-3 sm:bottom-8 sm:right-6">
        {/* VIP Offer sticky CTA — rose */}
        <button
          onClick={() => setVipOpen(true)}
          className="group flex items-center gap-2 rounded-full bg-accent text-accent-foreground font-bold text-sm px-5 py-3 shadow-lg shadow-accent/25 hover:shadow-xl hover:shadow-accent/30 active:scale-95 transition-all duration-200 min-h-[48px] animate-fade-in"
