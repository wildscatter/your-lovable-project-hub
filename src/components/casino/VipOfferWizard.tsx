        ...
        <div className="px-5 sm:px-6 pb-6 pt-3 sm:pt-4 min-h-[300px] flex flex-col">
          {submitted && (
            <div className="flex-1 flex flex-col items-center justify-center text-center gap-4 animate-float-up py-4">
              ...
              <Button onClick={handleClose} className="mt-2 glow-pulse-btn bg-gradient-to-r from-primary to-teal-dim text-primary-foreground font-bold px-8 py-5 rounded-xl hover:opacity-90 min-h-[48px] active:scale-[0.98] transition-all">
                Back to Casinos
              </Button>
            </div>
          )}
          ...
          {!submitted && (
            <div className="flex items-center gap-3 mt-5 sm:mt-6 pt-4 border-t border-border">
              ...
              {step < 3 ? (
                <Button onClick={handleNext} className="bg-gradient-to-r from-primary to-teal-dim text-primary-foreground font-semibold px-6 sm:px-8 rounded-xl hover:opacity-90 transition-all min-h-[48px] active:scale-[0.98]">
                  Continue <ChevronRight className="h-4 w-4 ml-1" />
                </Button>
              ) : (
                <Button onClick={handleSubmit} disabled={submitting} className="glow-pulse-btn bg-gradient-to-r from-primary to-teal-dim text-primary-foreground font-semibold px-6 sm:px-8 rounded-xl hover:opacity-90 transition-all min-h-[48px] active:scale-[0.98]">
