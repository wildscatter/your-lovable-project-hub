        ...
        <div className="relative w-[140px] h-[140px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <div className="flex items-baseline gap-0.5 font-mono">
              <span className="text-2xl font-extrabold text-foreground">{pad(countdown.h)}</span>
              <span className="text-lg text-primary font-bold animate-pulse">:</span>
              <span className="text-2xl font-extrabold text-foreground">{pad(countdown.m)}</span>
              <span className="text-lg text-primary font-bold animate-pulse">:</span>
              <span className="text-2xl font-extrabold text-foreground">{pad(countdown.s)}</span>
            </div>
