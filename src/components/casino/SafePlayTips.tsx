...
const SafePlayTips = () => (
  <section id="safe-play" className="py-14 md:py-20">
    <div className="container mx-auto px-4 max-w-2xl">
      ...
      <div className="space-y-3">
        {tips.map((tip, i) => (
          <div key={i} className="flex items-center gap-4 rounded-xl border border-border bg-card p-5 hover:border-primary/20 transition-colors duration-300">
