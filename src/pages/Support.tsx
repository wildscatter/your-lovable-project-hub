  ...
  <div className="min-h-screen bg-background">
    ...
    <main className="py-12 md:py-20">
      <div className="container mx-auto px-4 max-w-3xl">
        <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-3">Support 24/7</h1>
        <p className="text-muted-foreground mb-10">We're here to help around the clock. Reach out anytime.</p>

        <div className="grid gap-6 sm:grid-cols-2">
          <div className="rounded-xl border border-primary/20 bg-primary/5 p-6 flex flex-col items-center text-center gap-3">
          ...
          <div className="rounded-xl border border-border bg-card p-6 flex flex-col items-center text-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-foreground">Available 24/7</h2>
